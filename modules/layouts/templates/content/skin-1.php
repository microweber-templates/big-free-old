...
<section class="<?php print $layout_classes; ?> edit safe-mode nodrop" field="layout-content-skin-1-<?php print $params['id'] ?>" rel="module">
    <div class="mw-le-spacer" id="spacer-layout-content-skin-1-<?php print $params['id'] ?>-top" style="height: 100px"></div>
    ...
    <div class="mw-le-spacer" id="spacer-layout-content-skin-1-<?php print $params['id'] ?>-bottom" style="height: 100px"></div>
</section>
