...
<section class="section <?php print $layout_classes; ?> ">
    ...
    <div class="container-fluid mw-layout-container no-element allow-drop edit nodrop" field="layout-content-skin-42-<?php print $params['id'] ?>" rel="module">
        <div class="row mh-650">
            <div class="col-12 col-sm-10 col-lg-6 mx-auto   mh-400 mb-5" style="background-image: url('<?php print template_url(); ?>assets/img/layouts/content-42.jpg');"></div>
            ...
            <div class="col-12 col-sm-10 col-lg-6 mx-auto text-center text-lg-start d-flex align-items-center mb-5">
                <div class="container-fluid-right-col-in-container ms-md-5">
                    <div class="allow-drop ps-lg-7">
                        ...
                        <h3 class="mb-4">Enlightenment Is Not Just One State</h3>
