...
<section class="section <?php print $layout_classes; ?> ">
    ...
    <div class="container mw-layout-container no-element   text-center edit safe-mode" field="layout-content-skin-2-<?php print $params['id'] ?>" rel="module">
      <div class="row">
          <div class="col-12 col-lg-10 col-lg-8 mx-auto  ">
              <div class="mb-4 icon-size-64px no-element">
                  <i class="safe-element mw-micon-Anchor mb-4 icon-size-64px"></i>
              </div>
