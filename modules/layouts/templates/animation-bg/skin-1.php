...
<div class="animation-backgrounds-1 mw-layout-dark-background">
    <section class="section bg-animation py-0 no-typing no-select  <?php print $layout_classes; ?> edit   nodrop" field="layout-animation-bg-skin-1-<?php print $params['id'] ?>" rel="module">
        <module type="background" id="background-layout--<?php print $params['id'] ?>" />

        <div class="container mh-100vh d-flex align-items-center justify-content-center">

            <div class="mw-layout-container no-element allow-drop row text-center allow-select safe-mode">
