...
<section class="section py-0 d-flex align-items-center justify-content-center">
    ...
    <div class="mw-layout-container container-fluid mh-100vh d-flex align-items-center justify-content-center no-element edit nodrop no-typing no-select" field="layout-header-skin-6-<?php print $params['id'] ?>" rel="module">
