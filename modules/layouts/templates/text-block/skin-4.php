...
<section class="section <?php print $layout_classes; ?> ">
    ...
    <div class="mw-layout-container no-element allow-drop container    safe-mode edit     no-typing no-select" field="layout-text-block-skin-4-<?php print $params['id'] ?>" rel="module">
