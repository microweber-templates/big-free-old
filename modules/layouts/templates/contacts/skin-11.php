...
<section class="section <?php print $layout_classes; ?> edit nodrop" field="layout-contacts-skin-11-<?php print $params['id'] ?>" rel="module" data-background-position="center center" data-bg-contain="true">
