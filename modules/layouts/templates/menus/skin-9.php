...
<section class="header-background">
    ...
    <div class="container-fluid px-xl-5 px-0 justify-content-center">
        <div class="row col-12 d-flex justify-content-center ">
           ...
           <div class="menu-header-skin-2  col-xl-4 py-2 d-block order-3 order-xl-1 d-flex justify-content-start">
               <button class="menu-toggle"></button>
               <nav>
                   <module type="menu" name="header_menu" id="header_menu-<?php print $params['id']; ?>" template="menu-skin-2"/>
               </nav>
           </div>
