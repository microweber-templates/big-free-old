...
<ul class="list-inline no-style mb-0">
    ...
    <?php if ($discord_enabled) { ?>
        <li class="me-2 my-2"><div class="   rounded-circle square w-45px d-flex align-items-center justify-content-center"><a href="//discord.com/invite/<?php print $discord_url; ?>" target="_blank" class="  text-opacity-5 position-absolute"><i class="mdi mdi-discord mdi-24px"></i></a></div></li>
    <?php } ?>
