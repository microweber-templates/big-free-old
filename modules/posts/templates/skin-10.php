                        ...
                        <div class="d-flex flex-column">
                            <a href="<?php print $item['link'] ?>" class="   d-block position-relative">
                                ...
                                <div class="img-as-background">
                                    <img style="max-height: 750px; width: auto; position: relative !important;" src="<?php print thumbnail($item['image'], 600, 600); ?>"/>
                                </div>
                                <?php endif; ?>
                            </a>

                                <small class="mt-2 d-block"><?php echo date_system_format($item['created_at']) ; ?></small>
                                <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                        ...
                        <div class="col-md-6 post-holder">
                            <div class="d-flex flex-column">
                                <a href="<?php print $item['link'] ?>" class="   d-block position-relative">
                                    ...
                                    <div class="img-as-background">
                                        <img height="150" width="250" src="<?php print thumbnail($item['image'], 450, 450); ?>" style="position: relative !important;"/>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                                        <a href="<?php print $item['link'] ?>" class="   text-dark"><h4 class="text-start text-left"><?php print $item['title'] ?></h4></a>
                                    <?php endif; ?>
