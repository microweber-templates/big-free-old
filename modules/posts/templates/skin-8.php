        ...
        <?php foreach ($data as $item): ?>
            ...
            if ($categories) {
                foreach ($categories as $category) {
                    $itemCats .= '<small class="text-dark font-weight-bold d-inline-block mb-2 text-start ">' . $category['title'] . '</small> ';
                }
            }
            ?>
                    ...
                    <div class="d-block d-sm-flex align-items-center h-100">
                        <div class="d-flex flex-column w-100 h-100 justify-content-start align-items-start">
                            ...
                            <?php if (!isset($show_fields) or $show_fields == false or in_array('description', $show_fields)): ?>
                                <p class="text-start mb-2"><?php print $item['description'] ?></p>
                            <?php endif; ?>
                            <br/>
                            ...
                            <div class="text-start m-t-auto">
                                <a href="<?php print $item['link'] ?>" class="  "><span><?php echo $read_more_text;?></span></a>
